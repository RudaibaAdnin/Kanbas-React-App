...
const initialState = {
  questions: [{ _id: "0", name: "New Question 123", description: "New Description",  points: "0", course: "random", type: "MULTIPLECHOICE"}],
  question: { _id: "0", name: "New Question 123", description: "New Description",  points: "0", course: "random", type: "MULTIPLECHOICE"},
};
